...
void walkPropertySSAValues(Operation *op,
...
bool hasPropertySSAUses(Value value, Operation *root);
bool propertySSAUseEmpty(Value value, Operation *root);
SmallVector<Operation *> getPropertySSAUsers(Value value, Operation *root);
bool hasPropertySSAResultUses(Operation *op, Operation *root);
